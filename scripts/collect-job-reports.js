...
// 检索词：覆盖「智联/Boss 品牌报告」+「大学生就业市场行情」+「各技术岗位薪资技能分析」
const QUERIES = [
  '智联招聘 就业报告',
  'BOSS直聘 研究院 报告',
  '智联招聘 校园招聘',
  ...
  '大学生就业 市场行情',
  '春招 秋招 应届生 就业',
  // 各技术岗位薪资/技能/前景分析（补充 collect-job-details.js 的发现层）
  '算法工程师 薪资 技能要求 2026',
  'Java工程师 薪资 就业前景',
  '前端工程师 薪资 技能要求',
  'Python工程师 薪资 就业前景',
...
// 策略1：从查询参数直接提取嵌入 URL（零网络开销，覆盖 apiclick.aspx）
// 策略2：跟随 HTTP 重定向
...
// 只保留与「就业/招聘/应届/岗位分析」相关的条目，过滤无关噪声
function isJobRelated(text) {
  return /(就业|招聘|智联|BOSS|看准|直聘|春招|秋招|应届|毕业生|职场|求职|人才|薪酬|工资|岗位|薪资|薪水|待遇|月薪|年薪|技能要求|就业前景|行业趋势|算法工程师|Java工程师|Python工程师|Go工程师|前端工程师|后端工程师|全栈工程师|数据分析师|数据科学家|产品经理|测试工程师|运维工程师|DevOps|UI设计师|UX设计|AI工程师|大模型工程师|嵌入式工程师|安全工程师)/.test(text)
}
